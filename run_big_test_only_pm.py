"""2022 Model backtest — full 1m_data.csv (2016-2025), PM session only.

Runs the ICT 2022 Model on the full dataset with the PM killzone filter
(13:00–16:00 ET) and writes all results to big_test_only_pm/.

Usage:
    python3 run_big_test_only_pm.py
"""
...
RESULTS_DIR = Path("big_test_only_pm")
...
def main() -> None:
    print("=" * 65)
    print(" ICT 2022 Model — Full Dataset (2016-2025)  |  PM Session Only")
    print("=" * 65)
    ...
    # ------------------------------------------------------------------
    # Run model — PM session only
    # ------------------------------------------------------------------
    print("\nRunning 2022 Model (PM killzone only: 09:30–12:00 ET) …")
    ...
    print("\n=== OVERALL STATS (PM only, 2016-2025) ===")
